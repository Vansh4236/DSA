...
{
    string str;
    cout<<"Enter a string you want to convert : ";
    getline(cin,str);

    bool valid = parenthesis_matching(str);

    cout<<"POP-UP : The entered function is "<< (valid?"valid":"invalid") <<endl;
    if(!valid)
        return 0; 

    cout<<"The exprssion in the postfix form : "<<postfix_convert(str)<<endl;
